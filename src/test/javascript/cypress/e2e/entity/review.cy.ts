...
describe('Review e2e test', () => {
  ...
  const reviewSample = { rating: 2, reviewDate: '2025-02-05T00:13:19.486Z' };
  ...
  describe('new Review page', () => {
    ...
    it('should create an instance of Review', () => {
      ...
      cy.get(`[data-cy="reviewDate"]`).type('2025-02-04T12:41');
      cy.get(`[data-cy="reviewDate"]`).blur();
      cy.get(`[data-cy="reviewDate"]`).should('have.value', '2025-02-04T12:41');
