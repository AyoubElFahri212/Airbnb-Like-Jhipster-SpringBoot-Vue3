...
import ma.fullstackclone.airbnb.service.PromotionQueryService;
...
/**
 * REST controller for managing {@link ma.fullstackclone.airbnb.domain.Promotion}.
 */
@RestController
...
public class PromotionResource {
    ...
    /**
     * {@code SEARCH  /promotions/_search?query=:query} : search for the promotion corresponding
     * to the query.
     *
