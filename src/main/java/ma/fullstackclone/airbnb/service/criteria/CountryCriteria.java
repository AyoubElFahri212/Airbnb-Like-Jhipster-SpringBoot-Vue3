...
/**
 * Criteria class for the {@link ma.fullstackclone.airbnb.domain.Country} entity. This class is used
 * in {@link ma.fullstackclone.airbnb.web.rest.CountryResource} to receive all the possible filtering options from
...
public class CountryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, code, phoneCode, distinct);
    }
